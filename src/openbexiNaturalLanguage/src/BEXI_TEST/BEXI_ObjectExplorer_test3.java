...
public class BEXI_ObjectExplorer_test3 extends TestCase {
    public BEXI_ObjectExplorer_test3(String test) {
        super(test);
    }
    ...
    public void testSomething() throws Exception {
        ...
        String[] attributList = {"flexion", "racine", "type", "genre", "mode", "temps", "nombre", "personne", "définition"};
            ...
            try {
                ...
                while ((line = read.readLine()) != null) {
                    ...
                    if (startFound == true && !line.equals("") && !line.equals("------------------------- FIN DU FICHIER --------------------------------") && !line.equals("----------------------- FIN DE LA LICENCE ABU --------------------------------")) {
                        ...
                        try {
                            dictionary = new BEXI_Object("French", "mot", listWord[0], attributList, null, null, null, false);
